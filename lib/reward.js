...
const CNY_PER_KWH = required('../config').CNY_PER_KWH;
const USD_PER_KWH = Math.round((CNY_PER_KWH / USD2CNY) * 1000) / 1000;
...
const COINS = {
  ...
  BSD: '201-bsd-xevan',
  MONA: {
    path: '148-mona-lyra2rev2',
    hashrateHandler: M2K
  },
  XMR: {
    path: '101-xmr-cryptonight',
    hashrateHandler: M2K
  }
}
